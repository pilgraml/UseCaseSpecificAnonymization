...
#GCKD_df1_QI_cat$BL_ku_weight <- factor(GCKD_df1_QI_cat$BL_ku_weight, levels = c("[40, 60[", "[60, 80[", "[80, 100[", "[100, 120[", "[120, 140[", "[140, 160[", "[160, 180[", "[180, 200["))
#GCKD_df1_QI_cat$BL_ku_weight <- factor(GCKD_df1_QI_cat$BL_ku_weight, levels = c("[40, 80[", "[80, 120[", "[120, 160["))
#GCKD_df1_QI_cat$BL_ku_bmi <- factor(GCKD_df1_QI_cat$BL_ku_bmi, levels = c("[5, 18.5[", "[18.5, 25[", "[25, 30[", "[30, 35[", "[35, 40[", "[40, 250["))
...
if(is.character(GCKD_df1$BL_ku_bmi) == TRUE){
  print(table(GCKD_df1$BL_ku_bmi == "[30, 35[" | GCKD_df1$BL_ku_bmi == "[35, 40[" | GCKD_df1$BL_ku_bmi == "[40, 250[",  useNA = "always"))  
  print(prop.table(table(GCKD_df1$BL_ku_bmi == "[30, 35[" | GCKD_df1$BL_ku_bmi == "[35, 40[" | GCKD_df1$BL_ku_bmi == "[40, 250["))%>% '*'(100) %>% round(1))
  print(table(GCKD_df1$BL_ku_bmi == "[25, 30[",  useNA = "always"))
  print(prop.table(table(GCKD_df1$BL_ku_bmi == "[25, 30["))%>% '*'(100) %>% round(1))
  print(table(GCKD_df1$BL_ku_bmi == "[5, 18.5[" | GCKD_df1$BL_ku_bmi == "[18.5, 25[",  useNA = "always"))
  print(prop.table(table(GCKD_df1$BL_ku_bmi == "[5, 18.5[" | GCKD_df1$BL_ku_bmi == "[18.5, 25[")) %>% '*'(100) %>% round(1))
} else{
...
if(is.character(GCKD_df1_fem$BL_ku_bmi) == TRUE){
  print(table(GCKD_df1_fem$diabetes, GCKD_df1_fem$BL_ku_bmi == "[30, 35[" | GCKD_df1_fem$BL_ku_bmi == "[35, 40[" | GCKD_df1_fem$BL_ku_bmi == "[40, 250[",  useNA = "always"))  
  print(prop.table(table(GCKD_df1_fem$diabetes, GCKD_df1_fem$BL_ku_bmi == "[30, 35[" | GCKD_df1_fem$BL_ku_bmi == "[35, 40[" | GCKD_df1_fem$BL_ku_bmi == "[40, 250["), 1) %>% '*'(100) %>% round(1))
  ...
  print(table(GCKD_df1_fem$diabetes, GCKD_df1_fem$BL_ku_bmi == "[5, 18.5[" | GCKD_df1_fem$BL_ku_bmi == "[18.5, 25[",  useNA = "always"))
  print(prop.table(table(GCKD_df1_fem$diabetes, GCKD_df1_fem$BL_ku_bmi == "[5, 18.5[" | GCKD_df1_fem$BL_ku_bmi == "[18.5, 25["), 1) %>% '*'(100) %>% round(1))
  }else{
...
if(is.character(GCKD_df1_male$BL_ku_bmi) == TRUE){
  print(table(GCKD_df1_male$diabetes, GCKD_df1_male$BL_ku_bmi == "[30, 35[" | GCKD_df1_male$BL_ku_bmi == "[35, 40[" | GCKD_df1_male$BL_ku_bmi == "[40, 250[",  useNA = "always"))  
  print(prop.table(table(GCKD_df1_male$diabetes, GCKD_df1_male$BL_ku_bmi == "[30, 35[" | GCKD_df1_male$BL_ku_bmi == "[35, 40[" | GCKD_df1_male$BL_ku_bmi == "[40, 250["), 1) %>% '*'(100) %>% round(1))
  ...
  print(table(GCKD_df1_male$diabetes, GCKD_df1_male$BL_ku_bmi == "[5, 18.5[" | GCKD_df1_male$BL_ku_bmi == "[18.5, 25[",  useNA = "always"))
  print(prop.table(table(GCKD_df1_male$diabetes, GCKD_df1_male$BL_ku_bmi == "[5, 18.5[" | GCKD_df1_male$BL_ku_bmi == "[18.5, 25["), 1) %>% '*'(100) %>% round(1))
}else{
...
if(is.character(GCKD_df1_fem$BL_age) == TRUE){
  GCKD_df1_fem_less60 <- GCKD_df1_fem %>% subset(GCKD_df1_fem$BL_age == "[20, 40[" | GCKD_df1_fem$BL_age == "[40, 60[")
  ...
  GCKD_df1_fem_more60 <- GCKD_df1_fem %>% subset(GCKD_df1_fem$BL_age == "[60, 80[")
...
if(is.character(GCKD_df1_male$BL_age) == TRUE){
  GCKD_df1_male_less60 <- GCKD_df1_male %>% subset(GCKD_df1_male$BL_age == "[20, 40[" | GCKD_df1_male$BL_age == "[40, 60[")
  ...
  GCKD_df1_male_more60 <- GCKD_df1_male %>% subset(GCKD_df1_male$BL_age == "[60, 80[")
...
GCKD_df1_table_s3 %>%
  ...
  gt::gtsave(filename = "GCKD_titze_table_s3.html", 
             path = path_results)
if(is.character(GCKD_df1$BL_ku_bmi) == TRUE){
  print(table(GCKD_df1$DM, GCKD_df1$BL_ku_bmi == "[30, 35[" | GCKD_df1$BL_ku_bmi == "[35, 40[" | GCKD_df1$BL_ku_bmi == "[40, 250[",  useNA = "always"))  
  print(prop.table(table(GCKD_df1$DM, GCKD_df1$BL_ku_bmi == "[30, 35[" | GCKD_df1$BL_ku_bmi == "[35, 40[" | GCKD_df1$BL_ku_bmi == "[40, 250["), 1) %>% '*'(100) %>% round(1))
  ...
  print(table(GCKD_df1$DM, GCKD_df1$BL_ku_bmi == "[5, 18.5[" | GCKD_df1$BL_ku_bmi == "[18.5, 25[",  useNA = "always"))
  print(prop.table(table(GCKD_df1$DM, GCKD_df1$BL_ku_bmi == "[5, 18.5[" | GCKD_df1$BL_ku_bmi == "[18.5, 25["), 1) %>% '*'(100) %>% round(1))
}else{
